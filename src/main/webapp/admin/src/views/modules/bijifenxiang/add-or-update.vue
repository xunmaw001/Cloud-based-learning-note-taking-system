	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"0px 3%","background":"url(http://codegen.caihongy.cn/20230417/f15cd3c95ab74db6bb97dd6d6b40180e.png) no-repeat center bottom / 100% 100%"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' class="select" v-if="type!='info'"  label="分享类型" prop="fenxiangleixing">
					<el-select :disabled="ro.fenxiangleixing" v-model="ruleForm.fenxiangleixing" placeholder="请选择分享类型" >
						<el-option
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' class="date" v-if="type!='info'" label="分享日期" prop="fenxiangriqi">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' class="input" v-else-if="ruleForm.fenxiangriqi" label="分享日期" prop="fenxiangriqi">
					<el-input v-model="ruleForm.fenxiangriqi" placeholder="分享日期" readonly></el-input>
				</el-form-item>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `bijifenxiang/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
