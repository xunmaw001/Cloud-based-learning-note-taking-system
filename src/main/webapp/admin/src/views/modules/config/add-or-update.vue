	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"0px 3%","background":"url(http://codegen.caihongy.cn/20230417/f15cd3c95ab74db6bb97dd6d6b40180e.png) no-repeat center bottom / 100% 100%"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' class="upload" v-if="type!='info' && !ro.value" label="值" prop="value">
					<file-upload
						tip="点击上传值"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' class="upload" v-else-if="ruleForm.value" label="值" prop="value">
